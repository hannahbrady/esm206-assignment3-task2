...
sw_split_name <- starwars %>% 
  separate(col = name,
           ...
           sep = "-")
# Warning noted that row 49 had more than one dash in the name in the original starwars data frame. The third name "Mundi" was dropped and not listed in either column in the sw_split_name data frame.
```
...
```{r}
# Your code here: 
some_dates <- c(02292000,10312008,12312015)
